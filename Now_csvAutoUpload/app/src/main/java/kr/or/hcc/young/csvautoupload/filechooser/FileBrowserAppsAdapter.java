...
public class FileBrowserAppsAdapter extends BaseAdapter {
	...
	@Override
	public int getCount() {
		return mResources.getStringArray(R.array.app_file_browser).length;
	}

	@Override
	public Object getItem(int position) {
		return mResources.getStringArray(R.array.app_file_browser_action)[position];
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		item.setText(mResources.getStringArray(R.array.app_file_browser)[position]);
